...
import Main.GameModel.Menus.StartMenuPanel;
import Main.GameModel.Menus.EndGamePanel;
import javax.swing.*;
import java.awt.*;
    ...
    public void setFrame(String type) {
        ...
        switch(type) {
            ...
            case "game":
                ...
                this.jf.setSize(GameConstants.GAME_SCREEN_WIDTH + 20,GameConstants.GAME_SCREEN_HEIGHT + 150); // Adding space here to add my lives and healthBar
